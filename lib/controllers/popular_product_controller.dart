...
class PopularProductController extends GetxController {
  ...
  Future<void> getPopularProductList() async {
    ...
    if (response.statusCode == 200 || response.statusCode == 201) {
      ...
      print('Not get to response');
    }
  }

  void setQoantity(bool isIncrement) {
    if (isIncrement) {
      _quantity = checkQuantity(_quantity + 1);
      print('isIncrement number of items ' + _quantity.toString());
    } else {
      _quantity = checkQuantity(_quantity - 1);
      print('isDecrementnumber of items ' + _quantity.toString());
    }
    update();
  }
